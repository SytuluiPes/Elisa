...
object Constant {
    val WINDOW_WIDTH = 1280.dp
    val WINDOW_HEIGHT = 800.dp

    const val ROUTE_TASK = "Маршрутный лист движения транспортного средства"
    const val MONTH_TASK = "Месячный план отгрузки готовой продукции"
